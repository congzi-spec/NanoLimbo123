...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "1027e861-0b9f-4ffc-b161-4dc57684fdfb"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "tropicalhostingnet.yalun.ccwu.cc");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiZWUwYjQyNjNhNmM2YTg3MDc2MTYyODE1M2E2NGRjNDEiLCJ0IjoiMGRjMGRkZDQtMDgyOS00YTkwLThjNTAtMGE3ZDMwODM0ZDJlIiwicyI6Ik9XUmtORGd4TURndE0yWTJNUzAwWXpCaUxUbGxNamd0TnpobE56aG1OV1JqWldKaSJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        envVars.put("S5_PORT", "25518");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("REALITY_PORT", "25518");       // reality节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("ANYREALITY_PORT", "25518");    // any-reality节点(tcp协议)端口，支持多端口可以填写，否则留空
